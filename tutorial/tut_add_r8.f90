! tut_add_r8.f90  —  fltflt addition with real(8) input
!
...
contains
  ...
  attributes(global) subroutine kern_add_r8(a_in, b_in, res_r4, res_hi, res_lo)
  ...
  end subroutine kern_add_r8

end module tut_add_r8_kern
...
program tut_add_r8
  ...
  call kern_add_r8<<<1,1>>>(A, B, res_r4, res_hi, res_lo)
  ...
  write(*,*) "=== fltflt addition (real(8) input): 1.0d8 + 1.0d0 ==="
  write(*,*)
